...
<div class = 'jumbotron full vertical-center'>
  <div class = 'container text-center'>
    ...
    <div class = 'row text-center'>
      ...
      <div id="popup1" v-show = "active2">The Cape Cod Commission (CCC) is the regional land use planning, economic development, and regulatory agency created in 1990 to serve the citizens and 15 towns of Barnstable County, Massachusetts. The Cape Cod Commission is a department of Barnstable County regional government, but is funded separately through the Cape Cod Environmental Protection Fund and supplemented by grants.
      </div>
